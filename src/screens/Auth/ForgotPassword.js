...
const ForgotPassword = (props) => {
  ...
  const handleSubmitButton = () => {
    if (userEmail === "" || errorEmail !== "") {
      if (!userEmail) {
        setErrorEmail("*Please fill Mobile Number");
      }
    } else {
      setLoading(true);
      // const res = {
      ...
      var phone = userEmail.replace(/[^0-9]/g, "");
      forgotPassword(phone, (res) => {
        if (res.errors.length) {
          ...
          rec.type = "forgot";
          props.navigation.navigate("OtpVerification", { params: rec });
        } else {
      ...
      <View style={styles.whiteSection}>
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ alignItems: "center" }}>
          <View>
            ...
            >
              *******{props.route.params.params.digit}
            </ResponsiveText>
          ...
          <View>
            {loading ? (
              ...
              >
                ...
                >
                  <ResponsiveText style={{ color: Colors.White, fontSize: 3.5 }}>Recover Password</ResponsiveText>
